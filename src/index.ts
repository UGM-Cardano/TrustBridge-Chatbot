...
interface UserState {
  isVerified: boolean;
  awaitingCredential: boolean;
  transferFlow?: {
    step: 'recipient_name' | 'recipient_currency' | 'recipient_bank' | 'recipient_account' | 'sender_currency' | 'amount' | 'confirmation';
    data: {
...
function verifyCredential(credential: string): boolean {
