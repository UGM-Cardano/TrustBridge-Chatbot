...
export async function testCMCConnection() {
    if (!CMC_API_KEY) {
        return {
            success: false,
...
export async function fetchCryptoPrice(fromSymbol, toSymbol) {
    if (!CMC_API_KEY) {
...
export async function calculateRecipientAmount(senderAmount, fromCurrency, toCurrency) {
